        ...
        <>
            <section className='px-5 mt-20 mb-20'>
                <div className="bg-[#F1F1F1] relative rounded-lg mb-14">
                    <img src="assets\shared\desktop\image-category-thumbnail-headphones.png" alt="headphone" className="absolute w-36 top-[-1.90rem] left-1/2 -translate-x-1/2" />
                    <div className="flex flex-col justify-center items-center pb-6 pt-24">
                        <h1 className="font-extrabold uppercase tracking-wider">headphones</h1>
