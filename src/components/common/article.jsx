            ...
            <article className="flex justify-center">
                <div className="px-5 w-[335px] md:w-[768px] flex flex-col items-center lg:flex-row-reverse lg:w-auto lg:gap-articleColGap">
                    ...
                    <div className="text-center flex flex-col items-center lg:justify-center md:w-[36rem] lg:text-start lg:w-articleWidth">
                        <h1 className="uppercase font-bold text-[2rem] tracking-wide leading-10 py-10 md:text-[2.8rem] lg:text-articleTitle lg:leading-lineHeightClamp lg:tracking-articleTitle">Bringing you the <span className="text-[#D87D4A]">best</span> audio gear</h1>
                        <p className="lg:text-articleDesc">Located at the heart of New York City, Audiophile is the premier store for high end headphones,
